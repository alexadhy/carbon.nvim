...
function M.setup(config)
  ...
  theme.base = {
    ...
    Search = { bg = c.orange, fg = c.c.black }, -- Last search pattern highlighting (see 'hlsearch').  Also used for similar items that need to stand out.
    ...
    Function = { fg = c.red, style = config.functionStyle }, -- function name (also: methods for classes)
    ...
    mkdCodeStart = { fg = c.green, style = "bold" },
    mkdCodeEnd = { fg = c.green, style = "bold" },
    -- mkdLink = { fg = c.blue, style = "underline" },

    markdownHeadingDelimiter = { fg = c.red, style = "bold" },
    markdownCode = { fg = c.orange },
    markdownCodeBlock = { fg = c.green },
    markdownH1 = { fg = c.yellow, style = "bold" },
    markdownH2 = { fg = c.red, style = "bold" },
    markdownLinkText = { fg = c.cyan3, style = "underline" },
  ...
  theme.plugins = {
    ...
    diffIndexLine = { fg = c.red },

    -- Neogit
    NeogitBranch = { fg = c.red },
    NeogitRemote = { fg = c.yellow },
    ...
    WhichKeyDesc = { fg = c.dark5 },
    WhichKeySeperator = { fg = c.comment },
    WhichKeySeparator = { fg = c.comment },
    WhichKeyFloat = { bg = c.bg_sidebar },
    WhichKeyValue = { fg = c.fg1 },
    ...
    LspSagaCodeActionTitle = { fg = c.red },
    LspSagaCodeActionContent = { fg = c.purple },
    LspSagaSignatureHelpBorder = { fg = c.red },
    ReferencesCount = { fg = c.yellow },
    DefinitionCount = { fg = c.yellow },
    ...
    HopNextKey1 = { fg = c.yellow1, style = "bold" },
    HopNextKey2 = { fg = util.darken(c.yellow1, 0.3) },
    ...
    CmpItemKindVariable = { fg = c.yellow, bg = c.none },
    CmpItemKindConstant = { fg = c.yellow, bg = c.none },
    CmpItemKindReference = { fg = c.yellow, bg = c.none },
    CmpItemKindValue = { fg = c.green, bg = c.none },

    CmpItemKindFunction = { fg = c.red, bg = c.none },
    CmpItemKindMethod = { fg = c.red, bg = c.none },
    CmpItemKindConstructor = { fg = c.red, bg = c.none },
